...
; Orange hidden items
	...
	const EVENT_VALENCIA_PORT_SUSPICIOUS_MAN
	const EVENT_ALLOW_OVERWORLD_LIGHTNING
	const EVENT_VALENCIA_PORT_MONKEY_FOLLOW
	const EVENT_MONKEY_BITE_INFECTED
	const EVENT_MONKEY_BITE_INFECTED_OVERWORLD_MSG_SHOWN
	const EVENT_MONKEY_BITE_HEALED_NEW_DAY
	const EVENT_SEAKING_AT_WATERFALL
	const EVENT_SEAKING_AT_WATERFALL2
	const EVENT_SPINARAK_SPOOKED
	const EVENT_WATERFALL_SEAKING_RECEIVED
	const EVENT_PROF_RAMON_READY_TO_HEAL_MONKEY_BITE
