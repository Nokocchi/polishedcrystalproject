ValenciaPort_MapScriptHeader:
	...
	def_object_events
	object_event 13, 12, SPRITE_LYRA, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_VALENCIA_PORT_SUSPICIOUS_MAN
	object_event 13, 14, SPRITE_LYRA, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, TalkToMonkeyWhenFollow, EVENT_VALENCIA_PORT_MONKEY_FOLLOW
